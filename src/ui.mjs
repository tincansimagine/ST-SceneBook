...
export function mountSettings(api,container){
    ...
    const label=el('b','ap2-drawer-title','씬북'),version=el('small','ap2-version','0.4.18'),status=el('small','ap2-muted','');status.id='ap2-status';label.append(version);
