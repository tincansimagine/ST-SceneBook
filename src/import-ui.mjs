...
export function imageImport(api,onApplied){
    ...
    async function read(input){
        ...
        try{
            ...
            const labels={width:'가로',height:'세로',steps:'Steps',scale:'Guidance',sampler:'샘플러',scheduler:'스케줄러',cfgRescale:'CFG rescale',transparent:'투명 배경',useCoords:'좌표 적용',useOrder:'인물 순서'};
            ...
            preview.append(el('p','ap2-muted','설정 적용은 생성 옵션만, 장면 편집은 프롬프트·인물까지 가져옵니다. 시드는 가져오지 않으며 현재 설정을 유지합니다.'));
