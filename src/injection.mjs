...
- For an explicit sexual scene, the shared scene prompt MUST begin with concise model-readable tags: the precise visible character count, nsfw, explicit, sex, then the specific act or position. `nsfw` or `explicit` alone is insufficient.
